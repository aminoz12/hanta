...
export const metadata: Metadata = {
  title: "Masque Chirurgical Type IIR - Boîte de 20",
  description: "Masques chirurgicaux de type IIR à haute filtration (EFB ≥ 98%) avec résistance aux projections. Achat en ligne avec livraison 24h.",
};

export default function MasqueChirurgicalPage() {
  const product = getProductById('masque-chirurgical');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex text-sm text-gray-500">
            <ol className="flex items-center space-x-2">
              ...
              <li><span>/</span></li>
              <li className="text-secondary font-medium" aria-current="page">Masques Chirurgicaux</li>
            </ol>
          </nav>
        </div>
      </div>
